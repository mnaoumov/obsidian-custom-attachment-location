 ...
 * attachments before open, so its setup (populate + Obsidian startup index) and the
 * timing tests both need far more time than the regular integration projects.
 */
