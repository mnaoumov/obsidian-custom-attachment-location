...
/*
 * Desktop-only: no Android emulator is available in this environment. Canvas rename/attachment-move is
 * cross-platform, so renaming this file to `*.cross-platform.integration.test.ts` lifts it to
 * Android once an emulator exists.
 */

describe('Moving a canvas moves its embedded attachment (issue #22)', () => {
