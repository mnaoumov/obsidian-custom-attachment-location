  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'Некоторые плагины записывают вложение в хранилище под собственным именем, не спрашивая Obsidian, где ему место. Если включено, такой файл перемещается и переименовывается сразу после появления.',
