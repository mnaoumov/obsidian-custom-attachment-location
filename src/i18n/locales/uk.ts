  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'Деякі плагіни записують вкладення до сховища під власним іменем, не питаючи в Obsidian, де йому місце. Якщо це ввімкнено, такий файл переміщується та перейменовується одразу після появи.',
