  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'Некаторыя плагіны запісваюць далучэнне ў сховішча пад уласным імем, не пытаючыся ў Obsidian, дзе яму месца. Калі гэта ўключана, такі файл перамяшчаецца і перайменоўваецца адразу пасля з\'яўлення.',
