export const be = {
  ...
  collectAttachmentUsedByMultipleNotesModal: {
    ...
    noPriorityWinnerReason: {
      EmptyList: 'Ён не быў перамешчаны, бо налада {{settingName}} пустая, таму нішто не вызначае, якой з гэтых нататак ён належыць.',
      NoMatch: 'Ён не быў перамешчаны, бо ніводная з гэтых нататак не адпавядае ніводнаму запісу ў наладзе {{settingName}}.',
      Tie: 'Ён не быў перамешчаны, бо некалькі з гэтых нататак аднолькава адпавядаюць наладзе {{settingName}}, таму яна не называе адзінага ўладальніка.'
    },
  ...
  pluginSettings: {
    attachmentRenameMode: {
      ...
      onlyPastedImages: {
        description: 'перайменаваны толькі ўстаўленыя выявы. Ужываецца толькі калі змесціва PNG выявы ўстаўляецца непасрэдна з буфера абмену. Звычайна для ўстаўкі скрыншотаў.',
  ...
  pluginSettingsManager: {
    customToken: {
      codeComment: '// Карыстальніцкія токены былі закаментаваны, паколькі яны павінны быць абноўлены да новага фармату, уведзенага ў версіі плагіна 9.0.0.\n// Звярніцеся да дакументацыі (https://github.com/mnaoumov/obsidian-custom-attachment-location?tab=readme-ov-file#custom-tokens) для атрымання дадатковай інфармацыі.',
      deprecated: {
    ...
    validation: {
      ...
      specialCharactersReplacementMustNotContainInvalidFileNamePathCharacters: 'Замена спецыяльных сімвалаў не павінна змяшчаць няправільныя сімвалы шляху імя файла.'
    }
  },
  pluginSettingsTab: {
    attachmentRenameMode: {
    ...
    collectedAttachmentFileName: {
      description: {
        ...
        part2: 'токены',
        part3: 'Пакіньце пуста, каб захаваць зыходнае імя файла далучэння.'
      },
    ...
    customTokens: {
      description: {
        ...
        part3: 'дакументацыю',
        part4: 'для атрымання дадатковай інфармацыі.',
        part5: '⚠️ Карыстальніцкія токены могуць быць адвольным JavaScript кодам. Калі яны дрэнна напісаны, гэта можа прывесці да страты даных. Выкарыстоўвайце на свой рызыку.'
      },
    ...
    shouldConvertPastedImagesToJpeg: {
      description: 'Ці канвертаваць устаўленыя выявы ў JPEG. Ужываецца толькі калі змесціва PNG выявы ўстаўляецца непасрэдна з буфера абмену. Звычайна для ўстаўкі скрыншотаў.',
      name: 'Ці канвертаваць устаўленыя выявы ў JPEG'
    },
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        part1: 'Ці ўжываць налады папкі далучэнняў і імя файла да далучэнняў, якія ствараюць ІНШЫЯ плагіны.',
        part2: 'Некаторыя плагіны запісваюць далучэнне ў сховішча пад уласным імем, не пытаючыся ў Obsidian, дзе яму месца. Калі гэта ўключана, такі файл перамяшчаецца і перайменоўваецца адразу пасля з\'яўлення.',
        part3: 'Закранаюцца толькі файлы, створаныя пры адкрытай нататцы, і ніколі файлы, якія прыходзяць з сінхранізацыі ці імпарту сховішча.'
      },
      name: 'Перайменоўваць далучэнні, створаныя іншымі плагінамі'
    },
  ...
  promptWithPreviewModal: {
    fileNameTitle: 'Перайменаваць файл далучэння',
    folderTitle: 'Выберыце папку далучэнняў',
    previewModal: {
