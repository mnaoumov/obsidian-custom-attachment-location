  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'تكتب بعض الإضافات المرفق مباشرة في الخزنة باسم من اختيارها، دون سؤال Obsidian عن مكانه الصحيح. عند تفعيل هذا الخيار، يتم نقل هذا الملف وإعادة تسميته فور ظهوره.',
