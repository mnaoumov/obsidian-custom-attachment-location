  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'برخی افزونه‌ها پیوست را با نام دلخواه خود مستقیماً در گاوصندوق می‌نویسند، بدون آنکه از Obsidian بپرسند جای آن کجاست. با فعال بودن این گزینه، چنین فایلی بلافاصله پس از پدیدار شدن جابه‌جا و تغییر نام داده می‌شود.',
