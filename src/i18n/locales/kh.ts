  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'កម្មវិធីជំនួយខ្លះសរសេរឯកសារភ្ជាប់ចូលក្នុងឃ្លាំងដោយប្រើឈ្មោះផ្ទាល់ខ្លួន ដោយមិនសួរ Obsidian ថាវាគួរនៅកន្លែងណា។ ពេលបើកមុខងារនេះ ឯកសារបែបនេះនឹងត្រូវផ្លាស់ទី និងប្តូរឈ្មោះភ្លាមៗបន្ទាប់ពីវាលេចឡើង។',
