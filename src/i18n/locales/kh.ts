export const kh = {
  ...
  collectAttachmentUsedByMultipleNotesModal: {
    ...
    noPriorityWinnerReason: {
      EmptyList: 'វាមិនត្រូវបានផ្លាស់ទីទេ ព្រោះការកំណត់ {{settingName}} ទទេ ដូច្នេះគ្មានអ្វីសម្រេចថាកំណត់ចំណាំណាមួយក្នុងចំណោមនេះជាម្ចាស់វានោះទេ។',
      NoMatch: 'វាមិនត្រូវបានផ្លាស់ទីទេ ព្រោះគ្មានកំណត់ចំណាំណាមួយក្នុងចំណោមនេះត្រូវនឹងធាតុណាមួយក្នុងការកំណត់ {{settingName}} ឡើយ។',
      Tie: 'វាមិនត្រូវបានផ្លាស់ទីទេ ព្រោះកំណត់ចំណាំជាច្រើនក្នុងចំណោមនេះត្រូវនឹងការកំណត់ {{settingName}} ស្មើគ្នា ដូច្នេះវាមិនកំណត់ម្ចាស់តែមួយឡើយ។'
    },
  ...
  pluginSettingsManager: {
    customToken: {
      codeComment: '// សញ្ញាសម្គាល់ផ្ទាល់ខ្លួនត្រូវបានដកចេញពីមតិយោបល់ពីព្រោះពួកគេត្រូវតែបានធ្វើបច្ចុប្បន្នភាពទៅជាទម្រង់ថ្មីដែលបានណែនាំក្នុងកំណែផ្នែកបន្ថែម 9.0.0។\n// សូមមើលឯកសារយោង (https://github.com/mnaoumov/obsidian-custom-attachment-location?tab=readme-ov-file#custom-tokens) សម្រាប់ព័ត៌មានបន្ថែម។',
      deprecated: {
  ...
  pluginSettingsTab: {
    ...
    renameAttachmentsCreatedByOtherPluginsMode: {
      description: {
        part1: 'ថាតើត្រូវអនុវត្តការកំណត់ថតឯកសារភ្ជាប់ និងឈ្មោះឯកសារ ទៅលើឯកសារភ្ជាប់ដែលកម្មវិធីជំនួយផ្សេងបង្កើតឬអត់។',
        part2: 'កម្មវិធីជំនួយខ្លះសរសេរឯកសារភ្ជាប់ចូលក្នុងឃ្លាំងដោយប្រើឈ្មោះផ្ទាល់ខ្លួន ដោយមិនសួរ Obsidian ថាវាគួរនៅកន្លែងណា។ ពេលបើកមុខងារនេះ ឯកសារបែបនេះនឹងត្រូវផ្លាស់ទី និងប្តូរឈ្មោះភ្លាមៗបន្ទាប់ពីវាលេចឡើង។',
        part3: 'មានតែឯកសារដែលបង្កើតពេលកំណត់ត្រាកំពុងបើកប៉ុណ្ណោះដែលត្រូវប៉ះពាល់ មិនមែនឯកសារដែលមកពីការធ្វើសមកាលកម្ម ឬការនាំចូលឃ្លាំងឡើយ។'
      },
      name: 'ប្តូរឈ្មោះឯកសារភ្ជាប់ដែលកម្មវិធីជំនួយផ្សេងបានបង្កើត'
    },
  ...
  promptWithPreviewModal: {
    fileNameTitle: 'ប្តូរឈ្មោះឯកសារភ្ជាប់',
    folderTitle: 'ជ្រើសរើសថតឯកសារភ្ជាប់',
    previewModal: {
