  ...
  pluginSettingsTab: {
    ...
    shouldRenameAttachmentsCreatedByOtherPlugins: {
      description: {
        ...
        part2:
          'ปลั๊กอินบางตัวเขียนไฟล์แนบลงในห้องนิรภัยด้วยชื่อของตัวเอง โดยไม่ถาม Obsidian ว่าควรอยู่ที่ใด เมื่อเปิดตัวเลือกนี้ ไฟล์ดังกล่าวจะถูกย้ายและเปลี่ยนชื่อทันทีที่ปรากฏ',
