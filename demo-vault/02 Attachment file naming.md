...
2. Check the created file name in the folder from [[01 Attachment folder location]] - it starts with `file-` followed by a timestamp.
...
Related settings you can explore: `renamedAttachmentFileName`, `shouldRenameAttachmentFiles`, `attachmentRenameMode`, `duplicateNameSeparator`, and `collectedAttachmentFileName`. Every key is described in [[06 Settings]]. The tokens themselves live in [[03 Tokens and patterns]].
